...
- (void)requestTokenWithAuthGrant:(NSString *)authGrant redirectURL:(NSURL *)redirectURL;
{
    ...
    // Uncomment this if you want to use with other APIs.
    // NSMutableURLRequest *tokenRequest = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:tokenURL]];
    
    // Comment line below if you want to use OAuth2 with other APIs, instead of LinkedIn.
    NSMutableURLRequest *tokenRequest = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:[self URIWithParameters:authGrant redirectURL:redirectURL]]];
